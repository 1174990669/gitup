  ...
  grunt.initConfig({
    ...
    uglify: {
	 ...
	 cssmin: {
		 //文件头部输出信息
		cssbuild:{
		  src: ['css/global.css','css/index.css','css/login.css','css/lottery.css','css/user.css','css/news.css','css/activity.css','css/dropload.min.css','css/layer.css','css/dialog.css','css/mobile-select-area.css','css/mobiscroll.select.min.css','css/app_fix.css',],
